...
def main():
	...
	mul_log_reg.fit(dtm_train_x,train_dataset['sentiment'].astype(int))

	#evaluating the model
	train_accuracy=metrics.accuracy_score(train_dataset['sentiment'].astype(int),mul_log_reg.predict(dtm_train_x))
	...
	draw_confusionmatrix(cnf_matrix,classes,"MLR_Tfidf_n-gram=2_confusion matrix")
